...
namespace NRO_Server.Model.Info
{
    public class InfoDelay
    {
        ...
        {
            UsePea = -1;
            ChangeZone = 5000 + ServerUtils.CurrentTimeMillis();
            ChangeFlag = -1;
            ChatTheGioi = -1;
            TeleportToPlayer = -1;
            Trade = -1;
            AutoPlay = 20000 + ServerUtils.CurrentTimeMillis();
            ...
            SaveData = 30000 + ServerUtils.CurrentTimeMillis();

            UseGiftCode = 10000 + ServerUtils.CurrentTimeMillis(); 

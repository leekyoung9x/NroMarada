...
namespace NRO_Server.Model.Character
{
    public class Disciple : CharacterBase
    {
        ...
        public void CreatePet(Character character, int type,sbyte gender)
        {
            ...
            InfoChar.MaxStamina = 1250;
            IsFire = true;
            InfoChar.OriginalHp = InfoChar.Hp = ServerUtils.RandomNumber(8000, 1000);
            InfoChar.OriginalMp = InfoChar.Mp = ServerUtils.RandomNumber(8000, 1000);
            InfoChar.OriginalDamage = ServerUtils.RandomNumber(200, 600);
            InfoChar.OriginalDefence = ServerUtils.RandomNumber(200, 500);
            InfoChar.OriginalCrit = ServerUtils.RandomNumber(100) < 10 ? ServerUtils.RandomNumber(3, 6) : ServerUtils.RandomNumber(1, 4);
        ...
        public override short GetHead(bool isMonkey = true)
        {
            ...
            var item = ItemBody[5];
            if (item == null || (Type == 2 && !IsBienHinh) || (Type == 3 && !IsBienHinh) || (Type == 4 && !IsBienHinh) || (Type == 5 && !IsBienHinh)) return HeadLevel();
        ...
        public override short GetBody(bool isMonkey = true)
        {
            ...
            if (Type == 2 && Type == 3 && Type == 4 && Type == 5 && !IsBienHinh) return BodyLevel();
        ...
        public override short GetLeg(bool isMonkey = true)
        {
            ...
            if (Type == 2 && Type == 3 && Type == 4 && Type == 5 && !IsBienHinh) return LegLevel();

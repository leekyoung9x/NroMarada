    ...
    public class ItemHandler
    {
                                        ...
                                        switch (itemShop.Id)
                                        {
                                            ...
                                            case 933:
                                            {
                                                ...
                                                if (itemManhVoBongTai != null) 
                                                {
                                                    ...
                                                    {
                                                        soLuongManhVoBongTaiHT.Param += 99999;//default
                                                    }
                                                }
                                                else 
                                                {
        ...
        public static void UseItemBag(Model.Character.Character character, int index, short template = -1)
        {
            try
            {
                ...
                if (itemTemplate.IsTypeBody())
                {
                    ...
                    var indexInBody = itemTemplate.Type == 32 ? 6 : itemTemplate.Type == 11 ? 7 : itemTemplate.Type == 23 ? 8 : (itemTemplate.Type == 24 ?8 : itemTemplate.Type);
                ...
                switch (itemTemplate.Id)
                {
                    ...
                    case 454:
                    {
                        ...
                        else
                        {
                            ...
                            character.CharacterHandler.SendZoneMessage(Service.Fusion(character.Id, 9));
                            lock (character.InfoChar.Fusion)
                            {
        ...
        public static void UseItemForDisciple(Model.Character.Character character, int index, short template = -1)
        {
            try
            {
                ...
                if (itemTemplate.IsTypeBody())
                {
                    var indexInBody = itemTemplate.Type == 32 ? 6 : itemTemplate.Type == 11 ? 7 : itemTemplate.Type;

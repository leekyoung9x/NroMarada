    ...
    public class BossHandler : ICharacterHandler
    {
        ...
        public void LeaveItem(ICharacter character)
        {
			...
			if (ServerUtils.RandomNumber(100) < 50)
                {     
					var item = ItemCache.GetItemDefault(1098);
            ...
            switch(Boss.Type)
            {
                ...
                case 6://fide 3
                {
                    ...
                    var soSao = ServerUtils.RandomNumber(5, 7);
                    if (soSao > 0)
                    {
                ...
                case 14:
                {
                    ...
                    {
                        var itemHonLinhThu = ItemCache.GetItemDefault(1087);
                ...
                case 23://Whis
                    ...
                    //            if (randomPercent <= 13)
                    //            {
                    //                var item = ItemCache.GetItemDefault(14);
                    //                var itemMap = new ItemMap(playerKillId, item);
                    //                itemMap.X = Boss.InfoChar.X;
                    //                itemMap.Y = Boss.InfoChar.Y;
                    //                Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);
                    ...
                    //            if (randomPercent <= 15)
                    //            {
                    //               var item = ItemCache.GetItemDefault((short)ServerUtils.RandomNumber(14, DataCache.ListDoThanLinh[ServerUtils.RandomNumber(DataCache.ListDoThanLinh.Count)]));
                    //               var itemMap = new ItemMap(playerKillId, item);
                    //                itemMap.X = Boss.InfoChar.X;
                    //                itemMap.Y = Boss.InfoChar.Y;
                    //                Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);

    ...
    public class CharacterHandler : ICharacterHandler
    {
        ...
        public void Update()
        {
            ...
            if (Character.Delay.SaveInvData < timeServer && !Character.Delay.StartLogout && !Character.Delay.IsSavingInventory)
            {
                ...
                {
                    Character.Delay.InvAction = timeServer + 10000;
        ...
        public void SetHpFull()
        {
            ...
            if (Character.InfoChar.Fusion.IsFusion && Character.Disciple != null) {
                ...
                {
                    hp += (disHP + (disHP*60/100));
                }
                else if (Character.Disciple.Type == 5)
                {
                    hp += (disHP + (disHP*80/100));
                }
                // Bông tai porata 2
        ...
        public void SetMpFull()
        {
            ...
            if (Character.InfoChar.Fusion.IsFusion && Character.Disciple != null) {
                ...
                {
                    mp += (Character.Disciple.MpFull + (Character.Disciple.MpFull*60/100));
                }
                else if (Character.Disciple.Type == 5)
                {
                    mp += (Character.Disciple.MpFull + (Character.Disciple.MpFull*80/100));
                }
                // Bông tai porata 2
                if (Character.InfoChar.Fusion.IsPorata2)
                {
        ...
        public void SetDamageFull()
        {
            ...
            if (Character.InfoChar.Fusion.IsFusion && Character.Disciple != null) {
                ...
                {
                    damage += (disDmg + (disDmg*60/100));
                }
                else if (Character.Disciple.Type == 5)
                {
                    damage += (disDmg + (disDmg*80/100));
                }
                // Bông tai porata 2
                if (Character.InfoChar.Fusion.IsPorata2)
                {
        ...
        public void PlusPoint(IMonster monster, int damage)
        {
			...
			switch(Character.InfoChar.Task.Id)
			{
				...
				case 15:
				{
					if(Character.InfoChar.Task.Index == 0)
					{
						if (Character.InfoChar.Power > 2000000)
						{
                            Character.InfoChar.Task.Index++;
                            Character.CharacterHandler.SendMessage(Service.SendTask(Character));
						}
				...
				case 16:
				{
					if(Character.InfoChar.Task.Index == 0)
					{
						if (Character.InfoChar.Power > 5000000)
						{
                            Character.InfoChar.Task.Index++;
                            Character.CharacterHandler.SendMessage(Service.SendTask(Character));
						}
				...
				case 18:
				{
					if(Character.InfoChar.Task.Index == 0)
					{
						if (Character.InfoChar.Power > 150000000)
						{
                            Character.InfoChar.Task.Index++;
                            Character.CharacterHandler.SendMessage(Service.SendTask(Character));
						}
				...
				case 21:
				{
					if(Character.InfoChar.Task.Index == 0)
					{
						if (Character.InfoChar.Power > 1000000000)
						{
                            Character.InfoChar.Task.Index++;
                            Character.CharacterHandler.SendMessage(Service.SendTask(Character));
						}
                ...
                lock (zone.ItemMaps)
                {
                    ...
                    switch (itemNew.Id)
                    {
						...
						case 78:
						{
							...
							Character.InfoChar.Task.Count = 0;
                            SendMessage(Service.SendTask(Character));
                            SendMessage(Service.ServerMessage("Ui em loli này dễ thương quá,vác về nhốt tầng hàm thôiiii"));
                            break;
						}
						case 380:
						{

    ...
    public static class Giftcode
    {
        ...
        private static void UseCode(Model.Character.Character character, string code, int codeType)
        {
            if (codeType == 0)//Tân thủ
            {
                ...
                //character.CharacterHandler.SendMessage(Service.OpenUiSay((short)character.ShopId, @"Đã nhận thành công 200 tỏi vàng, 800k ngọc . Chúc bạn vui vẻ cùng NRO FREE"));
            } 
            ...
            //     character.CharacterHandler.SendMessage(Service.SendBag(character));
            //     character.CharacterHandler.SendMessage(Service.OpenUiSay((short)character.ShopId, "Đã nhận thành công 10 thỏi vàng, 5 vé quay thượng đế, 1 ngọc rồng 3 sao. Chúc bạn chơi game vui vẻ tại Ngọc Rồng FREE"));
            // }
            // else if (codeType == 2)//NRO FREE Bao tri code bảo trì reset tài khoản
            // {

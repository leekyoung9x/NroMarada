...
namespace NRO_Server.Application.Constants
{
    public class TextServer
    {
        ...
        public readonly string LOCK_LOGIN = "Vui lòng đăng ký tài khoản tại Key Vàng box Zalo NRO FREE để vào game";
        public readonly string NOT_ACTIVE = "Tài khoản của bạn chưa được kích hoạt\nTruy cập NRO FREE để kích hoạt tài khoản với phí chỉ 20k VNĐ bằng cách nạp card.";
        ...
        public readonly string DO_NOT_ACTION_DISCIPLE = "Hợp Thể";
        ...
        public readonly string NAP_VANG = "Hãy truy cập web NRO FREE để xem hướng dẫn nạp thêm VNĐ rồi quay lại đây nhé.";
        ...
        public readonly string UPGRADE_TO_PREMIUM = "Xin chúc mừng bạn đã là thành viên chính thức của NRO FREE";
        ...
        public readonly string PLEASE_USE_PORATA_3 = "Vui lòng sử dụng Bông Tai Porata Cấp 3";
        ...
        public readonly string TRANG_BI_ERROR_PORATA_3 = "Cần chọn đúng bông tai porata và mảnh vỡ bông tai";
        public readonly string TRANG_BI_ERROR_PORATA_3_FIRST = "Bạn cần chọn bông tai Porata bỏ vào trước";
        public readonly string TRANG_BI_ERROR_PORATA_3_SECOND = "Bạn cần bỏ vào đủ 9999 mảnh vỡ bông tai";
        public readonly string UPGRADE_OPTION_PORATA_3_ERROR_COUNT = "Cần chọn đúng bông tai Porata cấp 3, mảnh hồn porata và đá xanh lam, theo đúng thứ tự";
        public readonly string UPGRADE_OPTION_PORATA_3_FIRST = "Bạn cần chọn bông tai Porata cấp 3 bỏ vào trước";
        public readonly string UPGRADE_OPTION_PORATA_3_SECOND = "Bạn cần bỏ vào mảnh hồn bông tai x99 cái";

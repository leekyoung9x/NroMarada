...
namespace NRO_Server.Application.Constants
{
    public class DataCache
    {
        ...
        public static readonly int LIMIT_TRAIN_MANH_HON_BONG_TAI_NGAY = 9999;

        public static readonly int LIMIT_SLOT_RUONG_PHU_THUONG_DE = 100;

        public static List<short> LIMIT_SO_LAN_GOI_RONG = new List<short> { 7, 14 };//tài khoản thường, tài khoản premium

        public static readonly int LIMIT_NOT_PREMIUM_TRADE_DAY = 20;//ngày giao dịch 5 lần

        public static readonly long LIMIT_NOT_PREMIUM_TRADE_TIME = 300000;//10p giao dich 1 lan
        // Max cấp bậc sức mạnh
        public static readonly int MAX_LIMIT_POWER_LEVEL = 17;
        // Mở khóa sức mạnh mặc định
        public static readonly int DEFAULT_LIMIT_POWER_LEVEL = 17;
        ...
        public static readonly long LIMIT_NOT_PREMIUM_TRADE_GOLD_AMOUNT = 1000000000;

        // Giá mở nội tại
        public static readonly int PRICE_UNLOCK_SPECIAL_SKILL = 50000000; //ngọc
        public static readonly int PRICE_UNLOCK_SPECIAL_SKILL_VIP = 2000; //vàng

        public static readonly long MAX_PLUS_BAG = 100;

        public static readonly int GiaBanThoiVang = 1000000000;
        ...
        public static List<short> IdMount = new List<short> { 349, 350, 351, 396, 532, 346, 347, 348, 733, 734, 735, 743, 744, 746, 795, 849, 897, 920, 1166 };
        ...
        #region Combinne
        public static readonly long MAX_LIMIT_UPGRADE = 16;
        public static readonly long MAX_LIMIT_SPL = 16;
        public static readonly int DIV_FAKE_PERCENT_PL = 2;//Chia tỉ lệ phần trăm thành công khi đục lổ trang bị, 50%/3 = 15% thành công
        public static readonly int DIV_FAKE_PERCENT_UPGRADE = 2;//
        ...
        public static List<List<int>> PercentUpgrade = new List<List<int>>{
            //số đá, vàng, %
            new List<int>(){2, 10, 500},
            new List<int>(){3, 20, 500},
            new List<int>(){4, 30, 500},
            new List<int>(){5, 40, 500},
            new List<int>(){6, 50, 500},
            new List<int>(){7, 60, 500},
            new List<int>(){8, 70, 500},
            new List<int>(){9, 80, 500},
            new List<int>(){10, 90, 500},
            new List<int>(){11, 100, 500},
            new List<int>(){12, 110, 500},
            new List<int>(){13, 120, 500},
            new List<int>(){14, 130, 500},
            new List<int>(){15, 140, 500},
            new List<int>(){16, 150, 500},
            new List<int>(){17, 160, 500}
        };

        public static List<int> PercentUpgradePorata2 = new List<int> { 100, 500000000, 100 };
        ...
        public static readonly int BOSS_WHIS_TYPE = 2;

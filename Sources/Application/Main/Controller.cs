                ...
                switch (command)
                {
                    ...
                    case -71:
                    {
                        ...
                        if (character == null) return;
                        {
                            ...
                            {
                                @char.InfoChar.ThoiGianChatTheGioi = timeServer + 5000;
                            }
                            ...
                            {
                                @char.InfoChar.ThoiGianChatTheGioi = timeServer + 50000;
                            }
                    ...
                    case 21:
                    {
                        ...
                        {
                            var timeDelay = (int) (delayChangeZone - timeServer) / 2000;
                        ...
                        if (!text.Equals(""))
                        {
                            switch(text)
                            {
                                ...
                                case "bien hinh1":
                                {
                                    var charReal = (Character) character;
                                    var disciple = charReal.Disciple;
                                    if (disciple != null && disciple.Type == 3)
                                    {
                                        disciple.IsBienHinh = !disciple.IsBienHinh;
                                        disciple.CharacterHandler.UpdateInfo();
                                        disciple.Character.CharacterHandler.SendMessage(Service.PublicChat(disciple.Id, "Biến hình chíu chíu"));
                                ...
                                case "bien hinh2":
                                {
                                    var charReal = (Character) character;
                                    var disciple = charReal.Disciple;
                                    if (disciple != null && disciple.Type == 4)
                                    {
                                        disciple.IsBienHinh = !disciple.IsBienHinh;
                                        disciple.CharacterHandler.UpdateInfo();
                                        disciple.Character.CharacterHandler.SendMessage(Service.PublicChat(disciple.Id, "Biến hình chíu chíu"));
                                ...
                                case "bien hinh3":
                                {
                                    var charReal = (Character) character;
                                    var disciple = charReal.Disciple;
                                    if (disciple != null && disciple.Type == 5)
                                    {
                                        disciple.IsBienHinh = !disciple.IsBienHinh;
                                        disciple.CharacterHandler.UpdateInfo();
                                        disciple.Character.CharacterHandler.SendMessage(Service.PublicChat(disciple.Id, "Biến hình chíu chíu"));
                        ...
                        if (!text.Equals("") && character != null && role == 1)
                        {
                                ...
                                if (text.Contains("oren"))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        disciple.CreatePet(character, 4,2);
                                ...
                                if (text.Contains("kamin"))
                                {
                                    var oldDisciple = character.Disciple;
                                    if (oldDisciple != null || DiscipleDB.IsAlreadyExist(-character.Id))
                                    {
                                        oldDisciple = new Disciple();
                                        oldDisciple.CreatePet(character, 3, 2);
                                        oldDisciple.Player = character.Player;
                                        oldDisciple.CharacterHandler.SetUpInfo();
                                        character.Disciple = oldDisciple;
                                        DiscipleDB.Update(oldDisciple);
                                    ...
                                    {
                                        var disciple = new Disciple();
                                        disciple.CreatePet(character, 3, 2);
                                        disciple.Player = character.Player;
                                        disciple.CharacterHandler.SetUpInfo();
                                        character.Disciple = disciple;
                                        character.InfoChar.IsHavePet = true;
                                ...
                                if (text.Contains("kaminoren"))
                                {
                                    var oldDisciple = character.Disciple;
                                    if (oldDisciple != null || DiscipleDB.IsAlreadyExist(-character.Id))
                                    {
                                        oldDisciple = new Disciple();
                                        oldDisciple.CreatePet(character, 5, 2);
                                        oldDisciple.Player = character.Player;
                                        oldDisciple.CharacterHandler.SetUpInfo();
                                        character.Disciple = oldDisciple;
                                        DiscipleDB.Update(oldDisciple);
                                    ...
                                    {
                                        var disciple = new Disciple();
                                        disciple.CreatePet(character, 5, 2);
                                        disciple.Player = character.Player;
                                        disciple.CharacterHandler.SetUpInfo();
                                        character.Disciple = disciple;
                                        character.InfoChar.IsHavePet = true;
                                ...
                                if (text.Contains("mabu"))
                                {
                                    var oldDisciple = character.Disciple;
                                    if (oldDisciple != null || DiscipleDB.IsAlreadyExist(-character.Id))
                                    {
                                        oldDisciple = new Disciple();
                                        oldDisciple.CreateNewMaBuDisciple(character, 2);
                                        oldDisciple.Player = character.Player;
                                        oldDisciple.CharacterHandler.SetUpInfo();
                                        character.Disciple = oldDisciple;
                                        DiscipleDB.Update(oldDisciple);
                                    ...
                                    {
                                        var disciple = new Disciple();
                                        disciple.CreateNewMaBuDisciple(character, 2);
                                        disciple.Player = character.Player;
                                        disciple.CharacterHandler.SetUpInfo();
                                        character.Disciple = disciple;
                                        character.InfoChar.IsHavePet = true;
                                        character.CharacterHandler.SendMessage(Service.Disciple(2, null));
                                        DiscipleDB.Create(disciple);
                                    }
                                }
                                #endregion
                                ...
                                else if (text.Contains("kenchill"))
                                {
                                    var charReal = (Character)character;
                                    var boss = new Boss();
                            ...
                            if (text.Contains("kentlt"))
                            {
                                var itemTlt = ItemCache.GetItemDefault(1088);
                                var itemMap = new ItemMap(character.Id, itemTlt);
                                itemMap.X = character.InfoChar.X;
                                itemMap.Y = character.InfoChar.Y;
                                character.Zone.ZoneHandler.LeaveItemMap(itemMap);
                            ...
                            case 1:
                            {
                                ...
                                if (character.InfoChar.Cards.ContainsKey(id) && character.InfoChar.Cards[id] != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        character.InfoChar.EffectAuraId = 0;
                                    }
